                        ...
                        <div class="modal-body">
                            <div class="all d-flex flex-row gap-4">
                                <div class="left d-flex flex-col gap-4 w-100">
                                    ...
                                    <div class="input">
                                        <div class="relative">
                                            <input type="number" value="<?php echo $row['price'] ?>" id="price_modal" name="price"
                                                class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                                placeholder=" " required />
                                    ...
                                    <div class="input">
                                        <div class="relative">
                                            <input type="text" value="<?= $row["area"] ?>" id="area" name="area"
                                                class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                                placeholder=" " required />
                                            <label for="area"
                                    ...
                                    <div class="input">
                                        <div class="relative">
                                            <input type="text" value="<?php echo $row['adresse'] ?> " id="adresse" name="adresse"
                                                class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                                placeholder=" " required />
                                            <label for="adresse"
                            ...
                            <div class="input">
                                ...
                                <input required
                                    ...
                                    name="primary" id="file_input" type="file">
                            </div>
                            <div class="input">
                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                ...
                                <input
                                    class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                    name="pictures[]" id="pictures" type="file" multiple>
                            </div>
                            <div class="input">
        ...
        <div class="relative w-full h-full max-w-md md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4">
                    ...
                    <span id="output" class="bg-green-100 text-green-800 text-sm font-medium "></span>
                    </li>
                </div>
            </div>
        </div>
        ...
        <div class="details">
            <div class="head">
                ...
                <div class=" adresse">
                    ...
                    <p id="adresse">
                        <?php echo $row['adresse'] ?> ,<span id="city">
                        <?php echo $row['cty'] ?></span>
                    </p>
                </div>
            </div>
            <div class="section" id="description">
                <h6>Description</h6>
                <div>
                    <p><span>Catégorie d'annonce:</span><span id="category">
                            <?= $row["category"] ?>
                        </span></p>
                    <p><span>Type d'annonce:</span><span id="type">
                            <?= $row["type"] ?>
                        </span></p>
                    <p><span>Superficie totale:</span><span id="area">
                            <?= $row["area"] ?>m²
                        </span></p>
                </div>
                <p id="description">
            ...
            <div class="d-grid gap-2">
                <button class="btn btn-primary" type="button" name='' data-bs-toggle='modal'data-bs-target='#add_announcement'>Update</button>
